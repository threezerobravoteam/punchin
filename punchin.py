...
driver.set_script_timeout(14)#设置页面加载超时
...
def punchin_btn(driver):
    ...
    try:
        ...
        print(e)
        pass
    ActionChains(driver).move_to_element(elem_dengji).perform()
    elem_dengji.click()
    sleep(0.2)
    ...
    try:
        ...
        print(e)
        pass
    ActionChains(driver).move_to_element(elem_fix_btn).perform()
    elem_fix_btn.click()
    sleep(0.2)
    ...
    try:
        ...
        ActionChains(driver).move_to_element(elem_slot_btn).perform()
        elem_slot_btn.click()
...
def rest_btn(driver):
    ...
    try:
        ...
        print(e)
        pass
    ActionChains(driver).move_to_element(elem_fugang_btn).perform()
    elem_fugang_btn.click()
    sleep(0.5)
    #选择"居家办公"
    try:
        ...
        print(e)
        pass
    ActionChains(driver).move_to_element(elem_jujia).perform()
    elem_jujia.click()
    sleep(0.1)
    #选择确认
    try:
        ...
        print(e)
        pass
    ActionChains(driver).move_to_element(elem_confirm_btn).perform()
...
#判断是否需要验证码才能登录
    try:
        success = driver1.find_element_by_class_name("hb_bg")
        if success:
            print("3.登录成功！！准备打卡。")
